...
This program does a depth first search for the number of sets of verticies that share no edges.

Redundency is kept down by ensuring that the verticies of the independant set are lexicographicaly increasing.
