...
This program does a depth first search for the vertex chromatic number of a graph. ie the minimum number of vertex partitions such that no partition contains an edge.
